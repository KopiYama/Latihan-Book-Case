...
public class RepositoryBook {
    ...
    public List<CommercialBook> getBooks() {
        return books;
    }

    public void setBooks(List<CommercialBook> books) {
        this.books = books;
    }
    ...
    private void initializeDummyData() {
        ...
        books.add(new Comic("Comic-007", "Petualangan di Indonesia", mangaka4, publisher6, 0.0, false));
        books.add(new Comic("Comic-008", "Petualangan di Jakarta", mangaka5, publisher5, 0.0, false));
    }
